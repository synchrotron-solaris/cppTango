...
then
	...
	docker exec cpp_tango sed -e "s/ZeroMQ_LIBRARY AND ZeroMQ_STATIC_LIBRARY/ZeroMQ_LIBRARY OR ZeroMQ_STATIC_LIBRARY/" /home/tango/cppzmq/libzmqPkgConfigFallback.cmake > /home/tango/cppzmq/libzmqPkgConfigFallback.cmake
fi
